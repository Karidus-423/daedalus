...
pub const @"f32" = f32;
pub const @"f64" = f64;
pub const @"f80" = c_longdouble;
pub const struct__DyanmicArray = extern struct {
    data: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    stored: Uint32 = @import("std").mem.zeroes(Uint32),
    limit: Uint32 = @import("std").mem.zeroes(Uint32),
};
pub const DynamicArray = struct__DyanmicArray;
pub const struct__Array = extern struct {
    data: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    len: Uint32 = @import("std").mem.zeroes(Uint32),
};
pub const Array = struct__Array;
pub const struct__String = extern struct {
    chars: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    len: Uint32 = @import("std").mem.zeroes(Uint32),
};
pub const String = struct__String;
pub const struct__List = extern struct {
    prev: [*c]struct__List = @import("std").mem.zeroes([*c]struct__List),
    data: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    next: [*c]struct__List = @import("std").mem.zeroes([*c]struct__List),
};
pub const List = struct__List;
pub extern fn String_CountCharsIn(bfr: [*c]String, ch: u8) Uint32;
pub extern fn String_Parse(str: [*c]const String, delimiter: u8) [*c]List;
pub extern fn String_GetLen(string: [*c]const u8) Uint32;
pub extern fn String_GetSub(str: [*c]const String, begin: Uint32, end: Uint32) [*c]String;
pub extern fn ArrayGetSub(arr: [*c]Array, t_size: usize, begin: Uint32, end: Uint32) [*c]Array;
pub extern fn List_CreateNode(data: ?*anyopaque) [*c]List;
pub extern fn List_Search(head: [*c]List, data: ?*anyopaque) [*c]List;
pub extern fn List_Insert(old_node: [*c]List, new_node: [*c]List) void;
pub extern fn List_Delete(head: [*c][*c]List, node: [*c]List) void;
pub extern fn List_Free(head: [*c]List) void;
...
pub export fn main() c_int {
    var str: String = String{
        .chars = "E.g.e.g",
        .len = @as(Uint32, @bitCast(@as(c_int, 8))),
    };
    _ = &str;
    var tokens: [*c]List = String_Parse(&str, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '.'))))));
    _ = &tokens;
    while (tokens.*.next != @as([*c]struct__List, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        tokens = tokens.*.next;
        var token: [*c]String = @as([*c]String, @ptrCast(@alignCast(tokens.*.data)));
        _ = &token;
        _ = printf("%s", token.*.chars);
    }
    return 0;
}
...
pub const _DyanmicArray = struct__DyanmicArray;
pub const _Array = struct__Array;
pub const _String = struct__String;
pub const _List = struct__List;
